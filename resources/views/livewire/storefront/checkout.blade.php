...
@script
<script>
    if (!window.__ixCheckoutFired && typeof fbq !== 'undefined') {
        window.__ixCheckoutFired = true;
...
@endscript    <h1 class="text-3xl font-extrabold uppercase tracking-tight mb-8 border-b border-black pb-6">{{ __('Commander') }}</h1>
